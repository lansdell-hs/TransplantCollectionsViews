...
--Set categorical bins on LAS scores   
   CASE WHEN TH.match_las_stop between 0 and 20 
      ...
      WHEN TH.match_las_stop between 20 and 30          
      then '20-<30' 
         
      WHEN TH.match_las_stop between 30 and 35
      then '30-<35' 
         
      WHEN TH.match_las_stop between 35 and 40       
      then '35-<40'
          
      WHEN TH.match_las_stop between 40 and 50   
      then '40-<50'
          
      WHEN TH.match_las_stop between 50 and 60         
      then '50-<60'
          
      WHEN TH.match_las_stop between 60 and 70 
      then '60-<70' 
...
--Set categorical bins on Ages    
   CASE WHEN tx.AGE between 0 and 1 
      then '<1'
...
--Roll up Blood subgroups   
   CASE WHEN tx.ABO in ('A','A1','A2','A2B') 
      then 'A'
	   else tx.ABO
	end as blood_type,
...
--Set categorical bins on MELD/PELD at Transplant   
   CASE WHEN tx.organ='LI' and li.meld_peld_lab between 0 and 15 
      then 'MELD/PELD <15'
